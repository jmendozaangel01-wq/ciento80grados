...
export const PROJECTS = [
  {
    ...
    tag: 'Herramienta IA · Plataforma',
    category: 'ia',
    year: '2026',
    role: 'Producto, arquitectura e integración IA',
    desc: 'Plataforma multi-tenant que analiza la marca de cualquier web, Instagram o LinkedIn con IA.',
    detail: 'Plataforma multi-tenant de análisis de marca construida para Blue Bridge Global. Recibe la URL de un sitio web, un perfil de Instagram o uno de LinkedIn, lo scrapea con Apify y genera un análisis de marca específico para cada caso con Claude: identidad visual, paleta de colores, tipografía, auditoría SEO y de performance, benchmark contra competidores y próximos pasos recomendados. Los datos quedan en Supabase y el contenido visual on-brand se genera con Recraft. Incluye un agente Content Studio que conversa sobre los resultados del análisis y ayuda a crear y gestionar contenido social alineado con la identidad visual de cada marca. Nació con n8n y un frontend en HTML plano, y después se migró a una aplicación React completa.',
    problem: '',
    result: '',
    tech: ['React', 'Claude AI', 'n8n', 'Apify', 'Supabase', 'Recraft'],
    link: 'https://aibrand-one.vercel.app',
    cover: '/portfolio/ai-brand-architect.webp',
    gallery: [
      '/portfolio/ai-brand-architect-2.webp',
      '/portfolio/ai-brand-architect-3.webp',
      '/portfolio/ai-brand-architect-4.webp',
      '/portfolio/ai-brand-architect-5.webp',
      '/portfolio/ai-brand-architect-6.webp',
      '/portfolio/ai-brand-architect-7.webp',
      '/portfolio/ai-brand-architect-8.webp',
      '/portfolio/ai-brand-architect-9.webp',
      '/portfolio/ai-brand-architect-10.webp',
      '/portfolio/ai-brand-architect-11.webp',
      '/portfolio/ai-brand-architect-12.webp',
      '/portfolio/ai-brand-architect-13.webp',
      '/portfolio/ai-brand-architect-14.webp',
      '/portfolio/ai-brand-architect-15.webp',
    ],
    symbol: '○',
    featured: true,
  },
  {
    ...
    cover: '/portfolio/crc-clinica.webp',
    gallery: [
      '/portfolio/crc-clinica-2.webp',
      '/portfolio/crc-clinica-3.webp',
      '/portfolio/crc-clinica-4.webp',
      '/portfolio/crc-clinica-5.webp',
    ],
    symbol: '○',
    featured: true,
  },
  ...
  },
  {
    ...
    cover: '/portfolio/bornos-buy.webp',
    gallery: [
      '/portfolio/bornos-buy-2.webp',
      '/portfolio/bornos-buy-3.webp',
      '/portfolio/bornos-buy-4.webp',
      '/portfolio/bornos-buy-5.webp',
    ],
    symbol: '○',
    featured: true,
  },
